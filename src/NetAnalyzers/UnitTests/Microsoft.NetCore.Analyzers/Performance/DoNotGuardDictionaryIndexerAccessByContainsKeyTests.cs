...
{
    public class DoNotGuardDictionaryIndexerAccessByContainsKeyTests
    {
        #region C# Tests
...
{{
    ...
    {{
        ...
        private const string DictionaryContainsKeyDifferentKey = @"
            string key = ""key"";
            IDictionary<string, int> data = new Dictionary<string, int>();
...
End Namespace";
        ...
        public Task ShouldReportDiagnostic(string codeSnippet, string fixedCodeSnippet)
        {
            ...
            var diagnostic = VerifyCS.Diagnostic(DoNotGuardDictionaryOperationsAnalyzer.DoNotGuardIndexerAccessByContainsKeyRule).WithLocation(0).WithLocation(1);
        ...
        [InlineData(DictionaryContainsKeyDifferentKey)]
        ...
        public Task VbShouldReportDiagnostic(string codeSnippet, string fixedCodeSnippet)
        {
            ...
            var diagnostic = VerifyVB.Diagnostic(DoNotGuardDictionaryOperationsAnalyzer.DoNotGuardIndexerAccessByContainsKeyRule).WithLocation(0).WithLocation(1);
